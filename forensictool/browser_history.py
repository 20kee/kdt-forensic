...
class BrowserForensicTool:
    ...
    def get_file_path(self, browser_name, profile_path, file_name=None):
        if browser_name == 'firefox':
            ...
            return os.path.join(profile_path, 'Google', browser_name.capitalize(), 'User Data', 'Default', suffix, file_name)
        elif browser_name == 'edge':
            return os.path.join(profile_path, 'Microsoft', 'Windows', 'WebCache', 'WebCacheV01.dat')

    def copy_browser_data(self, dest):
        print(1)
